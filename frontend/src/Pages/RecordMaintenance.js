...
function RecordMaintenancePage() {
    ...
    const onsubmit = async (data) => {
        console.log(data)
        try {
            await axios.put('http://localhost:3002/Car/carMaintenanceRecord/' + vid , {
            ...
            <div className="w-4/5">
                ...
                <div className="my-8 border rounded-2xl py-8 px-12">
                    ...
                    <form onSubmit={handleSubmit(onsubmit)}>
                        <RegularInputField id='maintenance' label='Maintenance Details' name='maintenance' autofocus={true} placeholder='Details' register={register('maintenance')} />
                        {errors.maintenance && <p className="text-red-500 mt-4">{errors.maintenance.message}</p>}
